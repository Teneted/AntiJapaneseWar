...
public class KmtSolider extends PathfinderMob implements RangedAttackMob {

    private final RangedGunAttackGoal<KmtSolider> gunAttackGoal = new RangedGunAttackGoal<>(this, 1.0D, 20, 15.0F);
    private final SoliderMeleeAttackGoal meleeAttackGoal = new SoliderMeleeAttackGoal(this);

    public KmtSolider(EntityType<? extends PathfinderMob> p_32133_, Level p_32134_) {
    ...
    protected void populateDefaultEquipmentSlots(RandomSource p_218949_, DifficultyInstance p_218950_) {
        ...
        this.setItemSlot(EquipmentSlot.HEAD, new ItemStack(ModItems.KMT_SOLIDER_HELMET.get()));
