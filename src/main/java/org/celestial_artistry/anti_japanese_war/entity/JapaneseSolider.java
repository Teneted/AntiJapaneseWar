...
public class JapaneseSolider extends PathfinderMob implements RangedAttackMob {

    private final RangedGunAttackGoal<JapaneseSolider> gunAttackGoal = new RangedGunAttackGoal<>(this, 1.0D, 20, 15.0F);
    private final SoliderMeleeAttackGoal meleeAttackGoal = new SoliderMeleeAttackGoal(this);

    public JapaneseSolider(EntityType<? extends PathfinderMob> p_32133_, Level p_32134_) {
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(2, new NearestAttackableTargetGoal<>(this, KmtSolider.class, true));
