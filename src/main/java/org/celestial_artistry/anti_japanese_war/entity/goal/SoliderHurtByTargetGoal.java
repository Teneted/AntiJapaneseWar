...
public class SoliderHurtByTargetGoal extends TargetGoal {
    ...
    private final PathfinderMob solider;

    public SoliderHurtByTargetGoal(PathfinderMob p_26039_, Class<?>... p_26040_) {
        super(p_26039_, true);
        this.solider = p_26039_;
    ...
    public boolean canUse() {
        ...
        if (i != this.timestamp && livingentity != null) {
            if (livingentity.getType() == EntityType.PLAYER
                    && this.mob.level().getGameRules().getBoolean(GameRules.RULE_UNIVERSAL_ANGER) || solider.is(livingentity)) {
                return false;
            } else {
    ...
    public SoliderHurtByTargetGoal setAlertOthers(Class<?>... p_26045_) {
