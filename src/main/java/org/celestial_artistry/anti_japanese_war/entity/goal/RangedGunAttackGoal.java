...
public class RangedGunAttackGoal <T extends net.minecraft.world.entity.Mob & RangedAttackMob> extends Goal {
    ...
    public <M extends Monster & RangedAttackMob> RangedGunAttackGoal(M p_25792_, double p_25793_, int p_25794_, float p_25795_){
        this((T) p_25792_, p_25793_, p_25794_, p_25795_);
    }

    public RangedGunAttackGoal(T p_25792_, double p_25793_, int p_25794_, float p_25795_) {
        this.mob = p_25792_;
        ...
        if (livingentity != null) {
            ...
            if (this.mob.isUsingItem()) {
                if (!flag && this.seeTime < -60) {
                    ...
                    if (i >= 20) {
                        this.mob.stopUsingItem();
                        this.mob.performRangedAttack(livingentity, GunItem.getPowerForTime(i));
