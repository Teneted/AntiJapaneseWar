...
public class CpcSoliderRenderer extends LivingEntityRenderer<CpcSolider, PlayerModel<CpcSolider>> {


    private static final ResourceLocation TEXTURE_LOCATION =
            ResourceLocation.fromNamespaceAndPath(AntiJapaneseWarMod.MOD_ID,
                    "textures/entity/cpc_solider.png");

    public CpcSoliderRenderer(EntityRendererProvider.Context p_174557_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(CpcSolider p_114482_) {
