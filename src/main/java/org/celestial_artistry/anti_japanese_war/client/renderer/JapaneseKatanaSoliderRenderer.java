...
public class JapaneseKatanaSoliderRenderer extends LivingEntityRenderer<JapaneseKatanaSolider, PlayerModel<JapaneseKatanaSolider>> {

    private static final ResourceLocation TEXTURE_LOCATION =
            ResourceLocation.fromNamespaceAndPath(AntiJapaneseWarMod.MOD_ID,
                    "textures/entity/japanese_solider.png");

    public JapaneseKatanaSoliderRenderer(EntityRendererProvider.Context p_174557_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(JapaneseKatanaSolider p_114482_) {
