...
public class JapaneseSoliderRenderer extends LivingEntityRenderer<JapaneseSolider, PlayerModel<JapaneseSolider>> {
    ...
    public JapaneseSoliderRenderer(EntityRendererProvider.Context p_174557_) {
    ...
    @Override
    public ResourceLocation getTextureLocation(JapaneseSolider p_114482_) {
